...
writeFileSync(`${DIR}/tx-backup.json`, JSON.stringify(data))
writeFileSync(`${DIR}/tx-manifest.json`, JSON.stringify(MANIFEST, null, 2))
...
writeFileSync(`${DIR}/tx-report.txt`, report.join(`\n'))
