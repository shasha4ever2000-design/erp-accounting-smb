...
const STATUS_COLORS = {
  ...
  invoiced: 'bg-gray-100 text-gray-600 dark:bg-slate-700 dark:text-slate-300',
          ...
          <Table headers={['PO Number', 'Supplier', 'Order Date', 'Delivery Date', 'Status', { label: 'Total', right: true }, { label: 'Actions', right: true }]}>
            {sorted.map((po) => (
              <Tr key={po.id}>
                ...
                <Td>
                  <Badge className={STATUS_COLORS[po.status] || 'bg-gray-100 text-gray-600 dark:bg-slate-700 dark:text-slate-300'}>
                ...
                <Td right>
                  <div className="flex justify-end gap-1">
                    ...
                    {po.status === 'invoiced' && <span className="text-xs text-gray-400 dark:text-slate-500 px-2">Invoiced</span>}
