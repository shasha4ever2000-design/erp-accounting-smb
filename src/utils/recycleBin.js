...
export const RECYCLABLE = {
  ...
  employeeAdvances:  { slice: 'employeeAdvances',  label: 'Employee advance',   name: (r) => `${r.employeeName || ''}`.trim() },
  customerAdvances:  { slice: 'customerAdvances',  label: 'Customer advance',   name: (r) => `${r.customerName || ''}`.trim() },
