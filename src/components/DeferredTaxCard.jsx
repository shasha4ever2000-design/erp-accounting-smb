  ...
  return (
    <Card className="p-6">
      <div className="flex items-center gap-2.5 mb-4">
        ...
        <h2 className="text-base font-semibold text-slate-800 dark:text-slate-100">{t('Deferred Tax (IAS 12)')}</h2>
      </div>
      ...
      <label className="flex items-start gap-3 cursor-pointer mb-4">
        ...
        <span className="text-sm">
          <span className="font-medium text-slate-800 dark:text-slate-100">{t('Recognise deferred tax')}</span>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div>
          <label className="flex items-start gap-3 cursor-pointer mt-6">
            ...
            <span className="text-sm">
              <span className="font-medium text-slate-800 dark:text-slate-100">{t('Offset assets against liabilities')}</span>
              <span className="block text-slate-500 dark:text-slate-400 mt-0.5">
      ...
      <div className="flex items-center gap-3 mt-5">
        ...
        {saved && <span className="text-xs text-success-700 dark:text-success-400">{t('Saved')}</span>}
