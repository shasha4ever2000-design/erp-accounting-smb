...
1. **Check the package manager.** This project uses npm (see `package-lock.json`); unit tests run with Vitest via `npm test`, and Playwright E2E tests via `npm run e2e`.
