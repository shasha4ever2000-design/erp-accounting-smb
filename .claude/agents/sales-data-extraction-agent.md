...
description: "Sales Data Extraction Agent - AI agent specialized in monitoring Excel files and extracting key sales metrics (MTD, YTD, Year End) for internal live reporting"
color: blue
---
